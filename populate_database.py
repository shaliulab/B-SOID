...
def main():
    ...
    # analysis_files=["/home/vibflysleep/videos/FlyHostel2/1X/2023-05-23_14-00-00/flyhostel/single_animal/000050.mp4.predictions.h5"]

    for analysis_file in analysis_files:
        make_link(analysis_file, os.environ["BSOID_DATA"], dry_run=args.dry_run)
